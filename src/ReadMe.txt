================================================================================
    MICROSOFT FOUNDATION CLASS ライブラリ : HariboteServer プロジェクトの概要
===============================================================================



    アプリケーション ウィザードが作成した HariboteServer には Microsoft 
    Foundation Classes の基本的な使い方が示されています。アプリケーション作成のひな型としてお使い
    ください。
    このファイルには HariboteServer アプリケーションを構成している各ファイルの概要説明が含
    まれています。

HariboteServer.vcproj
...
HariboteServer.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CHariboteServerApp アプリケーション クラス
    の宣言をします。

HariboteServer.cpp
    このファイルは CHariboteServerApp アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\HariboteServer.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイルです。このアイコンは
    リソース ファイル HariboteServer.rc によってインクルードされます。

res\HariboteServer.rc2
...
res\Toolbar.bmp
    ...
    編集し、HariboteServer.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を変更してください。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) HariboteServer.pch や既にコン 
